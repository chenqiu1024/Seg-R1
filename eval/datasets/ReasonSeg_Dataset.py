...
from utils.reasonseg_data_processing import get_mask_from_json
# from .utils import (ANSWER_LIST, DEFAULT_IMAGE_TOKEN,
#                     EXPLANATORY_QUESTION_LIST, LONG_QUESTION_LIST,
#                     SHORT_QUESTION_LIST)

SHORT_QUESTION_LIST = [
    " Identify and segment {class_name}."

    # "What is {class_name} in this image? Identify and segment it.",
]

LONG_QUESTION_LIST = [
    "{sent} Identify and segment it.",
]
